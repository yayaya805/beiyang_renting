...
Page({
    ...
    data: {
        ...
        page: 0,
        // 默认公告信息
        notice:'欢迎使用天津大学北洋找房平台，这里有很多天大内部房源哦~'
    },
    ...
    */
    ...
    // },
      ...
      NavigateToDetail: function (e) {
        console.log(e,e.currentTarget.dataset.id)
        // let url = '../../Companypackage/houseDetail/houseDetail'
        let saleurl = '../../Companypackage/houseDetail/houseDetail'
        let renturl = '../../Companypackage/rentingHouseDetail/rentingHouseDetail'
        let Entrust_Type =  e.currentTarget.dataset.EntrustType
        let id = e.currentTarget.dataset.id
        let UserLogin = this.data.UserLogin
        if (UserLogin) {
            if(Entrust_Type ==="sale"){
                wx.navigateTo({
                url: `${saleurl}?id=${id}`,
            })
            }else{
